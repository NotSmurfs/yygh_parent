...
import com.sjr.yygh.vo.hosp.BookingScheduleRuleVo;
...
//        把日期转换为星期数
        for(BookingScheduleRuleVo bookingScheduleRuleVo:bookingScheduleRuleVosList){
...
//        设置最终数据进行返回
        ...
        result.put("bookingScheduleRuleList",bookingScheduleRuleVosList);
